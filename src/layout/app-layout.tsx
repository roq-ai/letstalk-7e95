...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Shipping', path: '/shippings', entity: 'shipping', service: AccessServiceEnum.PROJECT, icon: FiTruck },
    { name: 'Stock', path: '/stocks', entity: 'stock', service: AccessServiceEnum.PROJECT, icon: FiArchive },
